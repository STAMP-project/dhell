...
echo "--------------------------------------------------------------------------------" >>  $traceFile
java -Xms4096m -Xmx12288m -agentpath:/home/yosu/Development/visualvm_142/profiler/lib/deployed/jdk16/linux-amd64/libprofilerinterface.so=/home/yosu/Development/visualvm_142/profiler/lib,5140 -jar -jar $dspotJar --path-to-properties $dspotPropertiesFile -i 1 --test eu.stamp_project.examples.dhell.HelloAppTest -a MethodAdd --verbose 2>&1 | tee -a $traceFile
